...
(1, 'jheraldoc', 'José Heraldo Criollo López', 'admin', 1005964948, 'andres_felipe_2000@hotmail.com', 2, 'Un saludo de paz y bien. Soy el coordinador académico del Colegio San Francisco de Asís. Espero que tengan un buen día y que Dios les acompañe.', 'Administrador', '#4d9fdd', '', 0),
(2, 'gpatriciaa', 'Gloria Patricia Alzate', 'admin', 1005828482, 'correoparausoescolar15@gmail.com', 2, 'Un saludo de paz y bien a todos y a todas. Mi nombre es Gloria Patricia Alzate, soy la coordinadora disciplinaria del Colegio San Francisco de Asís. Una gran comunidad te espera. Matrículas abiertas ya.', 'Administradora', '#7e1f89', '', 0),
(3, 'jcarlosj', 'Juan Carlos Jaramillo', 'teacher', 1005828482, '16xxcarlosxx16@gmail.com', 1, 'Buenas a todos. Mi nombre es Juan Carlos Jaramillo, docente de Desarrollo de Software y Diseño Gráfico, con más de 10 años de experiencia en el Colegio San Francisco de Asís. Un saludo para todos.', 'Docente', '#000000', '11-A', 0);
